...
\item
	...
	\item
		...
		\begin{split}
			...
			\tau^{n} & = \frac{u(t_{n+1}) - u(t_{n})}{k} - f(u(t_{n})+ \frac{k}{2}f(u(t_{n}))) \\
			\tau^{n} &= \frac{1}{4}\mathcal{O}(h^{2}) + \frac{2}{3}\frac{3}{4}\mathcal{O}(h^{2}) \\
			\tau^{n} & = \frac{3}{4}\mathcal{O}(h^{2}), c_{2} = \frac{2}{3} \\ 
			U^{n+1} & = U^{n} +  \frac{k}{2} V_{1} +\frac{k}{2} V_{2} \\
			V_{1} &= f(t,u) \\
			V_{2} & = f(t+ \frac{k}{2}, u + \frac{k}{2} f(t,u)) \\ 
			\tau^{n} & = \frac{u(t_{n+1}) - u(t_{n})}{k} - f(u(t_{n})+ \frac{k}{2}f(u(t_{n}))) \\
			\tau^{n} &= \frac{1}{2}\mathcal{O}(h^{2}) + \frac{1}{2}\frac{1}{2}\mathcal{O}(h^{2}) \\
			\tau^{n} & = \frac{3}{4}\mathcal{O}(h^{2}), c_{2} = \frac{1}{2} \\ 
		\end{split}
		\end{equation*}
